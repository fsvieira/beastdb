...
class Table {
    ...
    forangeKey (field, forangeTable, acessor) {
        this.schema.forangeKeys.ids[field] = forangeTable;
        this.schema.forangeKeys.acessors[acessor] = field;

        return this;
    }

    type (field, type) {
        this.schema.types[field] = type;
        return this;
    }
